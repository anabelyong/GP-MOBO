...
def plot_pairwise_pareto_and_samples(known_Y_bo, pareto_Y_bo, known_Y_rs):
    print("Pareto Optimal Points from Bayesian Optimization (EHVI):")
    for point in pareto_Y_bo:
        print(point)
    fig, axs = plt.subplots(1, 3, figsize=(18, 6))

    axs[0].scatter(known_Y_bo[:, 0], known_Y_bo[:, 1], c="blue", label="BO Samples")
    axs[0].scatter(known_Y_rs[:, 0], known_Y_rs[:, 1], c="green", label="RS Samples")
    axs[0].scatter(pareto_Y_bo[:, 0], pareto_Y_bo[:, 1], c="red", label="Pareto Optimal Front")
    axs[0].set_xlabel("f1")
    axs[0].set_ylabel("f2")
    axs[0].legend()

    axs[1].scatter(known_Y_bo[:, 0], known_Y_bo[:, 2], c="blue", label="BO Samples")
    axs[1].scatter(known_Y_rs[:, 0], known_Y_rs[:, 2], c="green", label="RS Samples")
    axs[1].scatter(pareto_Y_bo[:, 0], pareto_Y_bo[:, 2], c="red", label="Pareto Optimal Front")
    axs[1].set_xlabel("f1")
    axs[1].set_ylabel("f3")
    axs[1].legend()

    axs[2].scatter(known_Y_bo[:, 1], known_Y_bo[:, 2], c="blue", label="BO Samples")
    axs[2].scatter(known_Y_rs[:, 1], known_Y_rs[:, 2], c="green", label="RS Samples")
    axs[2].scatter(pareto_Y_bo[:, 1], pareto_Y_bo[:, 2], c="red", label="Pareto Optimal Front")
    axs[2].set_xlabel("f2")
    axs[2].set_ylabel("f3")
    axs[2].legend()

    plt.suptitle("Pairwise Plots of Pareto Front with Samples")
    plt.show()
...
if __name__ == "__main__":
    ...
    # Plotting
    plot_pairwise_pareto_and_samples(known_Y_bo, pareto_Y_bo, known_Y_rs)
