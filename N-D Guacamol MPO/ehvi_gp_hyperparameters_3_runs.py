...
from utils.utils_guacamol import evaluate_objectives
...
def run_experiment(repeats, n_iterations):
    ...
    for experiment_num in range(1, repeats + 1):
        ...
        hyperparam_Y = evaluate_objectives(hyperparam_smiles)
        training_Y = evaluate_objectives(training_smiles)
...
if __name__ == "__main__":
    ...
    write_results_to_csv(results, 'bo_experiments_3_runs_results.csv')
