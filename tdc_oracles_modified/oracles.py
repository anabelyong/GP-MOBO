...
class Oracle:
    ...
    def assign_evaluator(self):
        ...
        #Fexofenadine MPO separated into 3 different oracle functions, TPSA, LOGP, FEX_SIMILARITY
            ...
            self.evaluator_func = tpsa_score_single
        elif self.name == "logp_score_single":
            from .chem_utils import logp_score_single

            self.evaluator_func = logp_score_single
        elif self.name == "fex_similarity_value_single":
